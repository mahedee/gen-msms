namespace MSMS.Web.Migrations
{
    ...
    public partial class firstmig : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        InstituteName = c.String(nullable: false, maxLength: 500),
                        Slogan = c.String(maxLength: 500),
                        Address = c.String(),
                        InstituteCode = c.String(nullable: false, maxLength: 100),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.FeeSettings", "ClassId", "dbo.ClassInfoes");
            ...
            DropIndex("dbo.FeeSettings", new[] { "ClassId" });
